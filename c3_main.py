...
from cifar_shallow import cifar100_shallow
...
parser.add_argument('--cubic-batch-size', default=32, type=int,
                    metavar='N', help='mini-batch size (default: 128)')
...
def cubic_approx(net, epoch, optimizer, criterion, inputs_grad, targets_grad, inputs_hv, targets_hv):
    ...
    net_delta_optimizer = torch.optim.SGD(net_delta.parameters(), lr=args.lr_cubic, momentum=args.cubic_momentum, weight_decay=0.0)
