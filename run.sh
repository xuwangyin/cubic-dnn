...
for model in vgg11_bn
do
    echo "python -u main.py  --arch=$model  --save-dir=save_$model |& tee -a log_$model_$1"
    /localtmp/yy8ms/anaconda3/bin/python main.py  --arch=$model  --save-dir=save_$model |& tee -a log_$model_$1
done
