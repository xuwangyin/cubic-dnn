...
# Data loading code
traindir = '/localtmp/data/imagenet/train'
valdir = '/localtmp/data/imagenet/val'
normalize = transforms.Normalize(mean=[0.485, 0.456, 0.406],
                                 std=[0.229, 0.224, 0.225])
...
def main():
    ...
    if args.resume:
        if os.path.isfile(args.resume):
            ...
            #optimizer.load_state_dict(torch.load(os.path.join(args.save_dir, 'checkpoint_optimizer{}.pth'.format(checkpoint['epoch']))))
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        torch.save(optimizer.state_dict(), os.path.join(args.save_dir, 'checkpoint_optimizer{}.pth'.format(epoch+1)))
