...
parser.add_argument('--rc', default=0.00001, type=float, help='cauchy point')
parser.add_argument('--cubic_epoch', default=10, type=float, help='cubic epoch')
...
def cubic_approx(net, epoch, optimizer, criterion, inputs_grad, targets_grad, inputs_hv, targets_hv):
    ...
    # outputs_grad, loss_grad = net_split_forward(net, criterion, inputs_array, targets_array)
    ...
    loss_grad_dummy = criterion(outputs_grad_dummy, targets_grad[:10].cuda())
